public class RandomNumbers {
  public static void main(String[] args){
    ...
    System.out.println( "1-6:t" + a + "\t" + b + "\t" + c +"\t" + d);

    //pick a single random integer, 1-100
    a = 1 + (int)( 100*Math.random() );
    System.out.println("1-100:\t" + a + "\t" + a + "\t" +a );
    ...
    System.out.println( "10-100:\t" + a + "\t" + b + "\t" + c + "\t" + d);



    //pick four random intefer, 0-99
